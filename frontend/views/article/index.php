...
$this->title = Yii::t('lan','Article').$type->type_name;
        ...
        <div class="breadcrumb col-md-4">
            <ul>
                ...
                <li class="active"  style="color:#fe7300 !important;">
                    <?=Html::a($this->title,['article/index','type_id' => $type->type_id]); ?>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="post-item">
                    ...
                    <div class="post-image">
                        <div class="effect social-links">
                            <?=Html::img($upload_path.'/article/thumb/'.$md->art_img,[
                            ...
                            <div class="image-box-content">
                                <p>
                                    <?=Html::a('<i class="fa fa-link"></i>',['article/view','id' => $md->art_id],[
                    ...
                    <div class="post-content-details">
                        ...
                        <div class="post-title">
                            <h4>
                                <?=Html::a($md->art_title,['article/view','id' => $md->art_id],['class' => 'art_title']); ?>
                            </h4>
                        </div>
                        ...
                        <div class="post-description">
                            <p style="text-indent: 2em;">
                                <?php
                                    echo Yii::$app->mhelpers->subdetail($md->art_detail,300);
                                ?>
                            </p>

                            <div class="post-read-more">
                                <?=Html::a(Yii::t('lan','read more').' <i class="fa fa-long-arrow-right"></i>',['article/view','id' => $md->art_id],['class' => 'read-more']); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="post-meta">
                        ...
                        <div class="post-comments" title="<?=Yii::t('lan','User Views'); ?>" alt="<?=Yii::t('lan','User Views'); ?>" style="color:green">
                            ...
                            <span class="post-comments-number"><?=$md->art_view; ?></span>
                        </div>
                    </div>
                </div>
                <?php 
