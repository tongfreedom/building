...
$this->title = Yii::t('lan','News').$type->type_name;
                    ...
                    <div class="post-image">
                        <div class="effect social-links">
                            ...
                            <div class="image-box-content">
                                <p>
                                    <?=Html::a('<i class="fa fa-link"></i>',['news/view','id' => $md->news_id],[
                    ...
                    <div class="post-content-details">
                        ...
                        <div class="post-description">
                            ...
                            <div class="post-read-more">
                                <?=Html::a(Yii::t('lan','read more').' <i class="fa fa-long-arrow-right"></i>',['news/view','id' => $md->news_id],['class' => 'read-more']); ?>
                            </div>
                        </div>
                    </div>
