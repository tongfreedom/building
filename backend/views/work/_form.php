...
<div class="work-form body">
    ...
    <?php
        ...
        if($lanID != 1){
            $attr = ['prompt' => '-- Portfolio Type --','disabled' => 'disabled'];
        }else{
            $attr = ['prompt' => '-- Portfolio Type --'];
        }
    ...
    <!-- Detail -->
    <div class="form-group field-work-work_detail">
    ...
    <div class="row clearfix">
        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
            <label for="">
                <?php echo $model->getAttributeLabel('work_img'); ?>
            </label>
        </div>
        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
            <div class="form-group">
                <div class="form-line">
                    <?php  
                        echo Yii::$app->mpic->picform($model,'work_img','work','work');
                    ?>
                </div>
            </div>
        </div>
