...
$this->params['breadcrumbs'][] = '<i class="material-icons">stars</i> '.$this->title;
?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-deep-orange">
                    <h2>
                        <i class="material-icons">stars</i> <?=$this->title; ?>
                    </h2>
                </div>
                    ...
                    foreach (Yii::$app->languages->all as $ln) {
                        ...
                        array_push($showData, [
                                ...
                                'value' => function ($data) use ($lan_id){
                                    // Find
                                    if($lan_id==1){
                                        $check = Work::findOne(['lan_id'=>$lan_id, 'work_id'=>$data->work_id]);
                                        $parent = null;
                                    }else{
                                        $check = Work::findOne(['lan_id'=>$lan_id, 'parent_id'=>$data->work_id]);
                                        $parent = $data->work_id;
                                    }
                                    if($check){
                        ...
                        [
                            ...
                            'buttons' => [
                                'view' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">visibility</i>', Yii::$app->urlManagerFrontEnd->createUrl(['work/view','id' => $model->work_id]), [
                                ...
                                'delete' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">delete</i>', 'javascript:void(0);', [
                                        ...
                                        'data-type' => 'delete',
                                        'data-url' => Yii::$app->homeUrl.'?r=work/delete&id='.$model->work_id,
                                    ]);
                                },
                            ]
                        ]
