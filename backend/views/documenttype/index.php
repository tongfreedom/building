        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                    ...
                    foreach (Yii::$app->languages->all as $ln) {
                        ...
                        array_push($showData, [
                                ...
                                'value' => function ($data) use ($lan_id){
                                    ...
                                    if($lan_id==1){
                                        $check = DocumentType::findOne(['lan_id'=>$lan_id, 'doc_type_id'=>$data->doc_type_id]);
                                        $parent = null;
                                    }else{
                                        $check = DocumentType::findOne(['lan_id'=>$lan_id, 'parent_id'=>$data->doc_type_id]);
                                        $parent = $data->doc_type_id;
                                    }
                                    if($check){
                                        return Html::a('<i class="material-icons">edit</i>', [
                                            'update', 
                                            'id'=>$check->doc_type_id,
                                            'lan_id'=>$lan_id,
                                            'parent_id' => $parent
                                        ],
                                        [
                        ...
                        [
                            ...
                            'buttons' => [
                                'view' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">visibility</i>', Yii::$app->urlManagerFrontEnd->createUrl(['article/view','id' => $model->doc_type_id]), [
                                ...
                                'delete' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">delete</i>', 'javascript:void(0);', [
                                        ...
                                        'data-type' => 'delete',
                                        'data-url' => Yii::$app->homeUrl.'?r=documenttype/delete&id='.$model->doc_type_id,
                                    ]);
                                },
                            ]
                        ]
                ...
                <?= SortableGridView::widget([
                    ...
                    'sortableAction' => url::to(['documenttype/sort']),
                    'tableOptions' => [
