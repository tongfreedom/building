...
$this->title = 'Gallery';
$this->params['breadcrumbs'][] = '<i class="material-icons">image</i> '.$this->title;
?>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header text-left bg-amber">
                            <h2>
                                <i class="material-icons">image</i> Search
                            </h2>
                        </div>
                        <?= $this->render('_search', [
                            'model' => $searchModel,
                    ...
                    foreach (Yii::$app->languages->all as $ln) {
                        ...
                        array_push($showData, [
                                ...
                                'value' => function ($data) use ($lan_id){
                                    ...
                                    if($lan_id==1){
                                        $check = Gallery::findOne(['lan_id'=>$lan_id, 'gall_id'=>$data->gall_id]);
                                        $parent = null;
                                    }else{
                                        $check = Gallery::findOne(['lan_id'=>$lan_id, 'parent_id'=>$data->gall_id]);
                                        $parent = $data->gall_id;
                                    }
                                    if($check){
                        ...
                        [
                            ...
                            'buttons' => [
                                'view' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">visibility</i>', Yii::$app->urlManagerFrontEnd->createUrl(['gallery/view','id' => $model->gall_id]), [
                                ...
                                'delete' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">delete</i>', 'javascript:void(0);', [
                                        ...
                                        'data-type' => 'delete',
                                        'data-url' => Yii::$app->homeUrl.'?r=gallery/delete&id='.$model->gall_id,
                                    ]);
                                },
                            ]
                        ]
