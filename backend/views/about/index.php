...
$this->title = 'About Us';
$this->params['breadcrumbs'][] = '<i class="material-icons">info</i> '.$this->title;
?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-deep-orange">
                    <h2>
                        <i class="material-icons">info</i> <?=$this->title; ?>
                    </h2>
                </div>
                    ...
                    foreach (Yii::$app->languages->all as $ln) {
                        ...
                        array_push($showData, [
                                ...
                                'value' => function ($data) use ($lan_id){
                                    ...
                                    if($lan_id==1){
                                        $check = About::findOne(['lan_id'=>$lan_id, 'about_id'=>$data->about_id]);
                                        $parent = null;
                                    }else{
                                        $check = About::findOne(['lan_id'=>$lan_id, 'parent_id'=>$data->about_id]);
                                        $parent = $data->about_id;
                                    }
                                    if($check){
                        ...
                        [
                            ...
                            'buttons' => [
                                'view' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">visibility</i>', Yii::$app->urlManagerFrontEnd->createUrl(['about/view','id' => $model->about_id]), [
                                ...
                                'delete' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">delete</i>', 'javascript:void(0);', [
                                        ...
                                        'data-type' => 'delete',
                                        'data-url' => Yii::$app->homeUrl.'?r=about/delete&id='.$model->about_id,
                                    ]);
                                },
                            ]
                        ]
                ...
                <?= SortableGridView::widget([
                    ...
                    'sortableAction' => url::to(['about/sort']),
                    'tableOptions' => [
