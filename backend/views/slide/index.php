...
$this->title = 'Slide';
$this->params['breadcrumbs'][] = '<i class="material-icons">slideshow</i> '.$this->title;
?>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header bg-deep-orange">
                    <h2>
                        <i class="material-icons">slideshow</i> <?=$this->title; ?>
                    </h2>
                </div>
                    ...
                    foreach (Yii::$app->languages->all as $ln) {
                        ...
                        array_push($showData, [
                                ...
                                'value' => function ($data) use ($lan_id){
                                    ...
                                    if($lan_id==1){
                                        $check = Slide::findOne(['lan_id'=>$lan_id, 'slide_id'=>$data->slide_id]);
                                        $parent = null;
                                    }else{
                                        $check = Slide::findOne(['lan_id'=>$lan_id, 'parent_id'=>$data->slide_id]);
                                        $parent = $data->slide_id;
                                    }
                                    if($check){
                            ...
                            'buttons' => [
                                'delete' => function ($url, $model) {
                                    return Html::a('<i class="material-icons">delete</i>', 'javascript:void(0);', [
                                        ...
                                        'data-type' => 'delete',
                                        'data-url' => Yii::$app->homeUrl.'?r=slide/delete&id='.$model->slide_id,
                                    ]);
                                },
                            ]
                        ]
                ...
                <?= SortableGridView::widget([
                    ...
                    'sortableAction' => url::to(['slide/sort']),
                    'tableOptions' => [
